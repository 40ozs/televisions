...
| pluginval strictness 5 (VST3, incl. editor under Xvfb) | `xvfb-run -a pluginval --strictness-level 5 --validate "build/.../VST3/HeardItOnTV.vst3"` | **PASS (exit 0, 19 test groups)** |
